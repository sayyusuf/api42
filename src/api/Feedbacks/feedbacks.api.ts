...
export class UsersApi {
   ...
   /**
     ...
     */
    public async get_feedbacks_with_id(id: string, params: FeedbacksParams): Promise<Any>{
  ...
  /**
     ...
     */
    public async get_feedbacks_with_event_id(event_id: string, params: FeedbacksParams): Promise<Any>{
  ...
  /**
     ...
     */
    public async get_feedbacks_with_scale_team_id(scale_team_id: string, params: FeedbacksParams): Promise<Any>{
  ...
  /**
     ...
     */
    public async get_feedbacks_with_event_id_and_id(event_id: string, id: string, params: FeedbacksParams): Promise<Any>{
  ...
  /**
     ...
     */
    public async get_feedbacks_with_event_id_and_id(scale_team_id: string, id: string, params: FeedbacksParams): Promise<Any>{
