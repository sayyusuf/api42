...
import { CoalitionsUsersIdParams, CoalitionsUsersParams } from "./coalitionsusers.params.type";
...
export class CoalitionsUsersApi {
     ...
     */
    public async get_coalitions_coalitionId_coalitionsUsers(coalition_id: number | string, params?: CoalitionsUsersParams): Promise<CoalitionsUser[]> {
     ...
     * @returns CoalitionsUser array
     */
    public async get_coalitionsUsers(params?: CoalitionsUsersParams): Promise<CoalitionsUser[]> {
     ...
     * @returns CoalitionsUser array
     */
    public async get_users_userId_coalitionsUsers(user_id: number | string, params?: CoalitionsUsersParams): Promise<CoalitionsUser[]> {
     ...
     * @returns CoalitionsUser array
     */
    public async get_coalitionsUsers_id(id: number | string, params?: CoalitionsUsersIdParams): Promise<CoalitionsUser> {
