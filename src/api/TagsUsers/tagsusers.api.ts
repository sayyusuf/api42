...
import { TagUsers } from "./tagsusers.types";
...
export class TagsUsersApi {
     ...
     */
    public async get_tagsUsers_id(id: string, params?: TagsUsersParams): Promise<TagUsers>{
   ...
   /**
     ...
     */
    public async get_tagsUsers(params?: TagsUsersParams): Promise<TagUsers[]>{
   ...
   /**
     ...
     */
    public async get_users_userId_tagsUsers(user_id: string, params?: TagsUsersParams): Promise<TagUsers[]>{
   ...
   /**
     ...
     */
    public async get_cursus_cursusId_tagsUsers(cursus_id: string, params?: TagsUsersParams): Promise<TagUsers[]>{
  ...
  /**
     ...
     */
    public async get_campus_campusId_tagsUsers(campus_id: string, params?: TagsUsersParams): Promise<TagUsers[]>{
  ...
  /**
     ...
     */
    public async get_tags_tagId_tagsUsers(tag_id: string, params?: TagsUsersParams): Promise<TagUsers[]>{
