...
export class GroupsApi {
  ...
  /**
     ...
     * @returns Get a group
     */
    public async get_groups_id(id: string, params: GroupsParams): Promise<GroupsTypes>{
   ...
   /**
     ...
     */
    public async get_groups_user_id(user_id: string, params: GroupsParams): Promise<GroupsTypes>{
