...
export class UsersApi {
  ...
  /**
   ...
   /**
     ...
     */
    public async get_tags_notion_id(cursus_id: string, params: TagsParams): Promise<TagsTypes>{
     ...
     */
    public async get_tags_issue_id(cursus_id: string, params: TagsParams): Promise<TagsTypes>{
